    ...
    experience: [
      {
        ...
        description: [
          ...
          "  **AI 기반 인테리어 서비스**: **4주 내 170개국 글로벌 런칭**. Gemini 선배포 및 LLM Provider 전환 구조 설계. 이후 IAP 구독 모델과 Langgraph 기반 워커 재설계로 수익화 및 확장성 확보.",
          "  **3D 인테리어 디자인 서비스**: **WAU 704%** 성장과 **연간 GMV 600%(8.6억)** 달성에 기여. 트래픽 **10.2배** 증가에도 **99.95% 가용성** 확보.",
    ...
    experience: [
      {
        ...
        description: [
          ...
          "  **AI-based Interior Service**: Achieved a **4-week launch to 170 countries**. Built Gemini pre-deployment and switchable LLM provider architecture. Post-launch: implemented IAP subscription model and Langgraph-based worker redesign for monetization and scalability.",
          "  **3D Interior Design Service**: Drove **704% WAU** growth and **600% annual GMV (₩860M)**. Maintained **99.95% availability** under **10.2x** traffic.",
